...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,5);function b(m,h){const p=a("RouterLink"),o=a("ExternalLinkIcon");return l(),c("div",null,[s("p",null,[n("As needed, read first the "),e(p,{to:"/helpers.html"},{default:r(()=>[n("Helper Overview")]),_:1}),n(".")]),d,s("p",null,[n("The API very closely matches the "),s("a",k,[n("Rust API"),e(o)]),n(".")]),v])}const _=i(u,[["render",b],["__file","helper.html.vue"]]);export{_ as default};
