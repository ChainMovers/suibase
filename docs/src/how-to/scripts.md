...
| <h3>twalrus<br>mwalrus<br>tsite<br>msite<br></h3>     | Frontends to the Mysten Labs **walrus** and **site-builder** binaries, each targeting a network (the proper config, context and wallet are added automatically):<br><p style="text-align:center"><b>t</b>walrus→<b>t</b>estnet,&nbsp;<b>m</b>walrus→<b>m</b>ainnet</p>Use `tsite`/`msite` instead of `site-builder` for Walrus Sites.<br><br>Example: `$ twalrus info`. For localnet support and more info, see [Walrus](../walrus.md).                                                                                                                                                                |
