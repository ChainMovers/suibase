/* Code/Component is from solanacookbook.com and has been renamed and *
significantly modified. * See
https://github.com/solana-developers/solana-cookbook/pull/36 for * the original
(and thanks). */
...
export default defineComponent({
  ...
  setup(_, { slots }) {
    ...
    const copyActiveToClipboard = () => {
      ...
      let children = preview.value
        ? activeItem.children["preview"]()
        : activeItem.children["default"]();
              ...
              return h(
                ...
                h(
                  "button",
                  {
                    ...
                    class: {
                      "code-tabs-nav-tab": true,
                      "code-tabs-nav-tab-active": isActive,
                    },
