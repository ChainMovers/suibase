...
function shortAddr(addr: string): string {
  ...
  // Given a string, take the first and last 4 digits of addr, use "~" as middle seperator.
  // Example: "1234567890" => "0x1234~7890"
  return "0x" + (addr.length > 7 ? addr.slice(0, 4) + "~" + addr.slice(-4) : addr);
}
...
const CustomTreeItem = React.forwardRef(function CustomTreeItem(
  ...
  const renderItemIcons = () => {
    return (
      <>
        {to_clipboard && <CopyToClipboardButton text={to_clipboard} message="Copied" />}
